  ...
  render() {
    return (
      <div className={css(style.appBody)}>
        ...
        <form action="" className={css(style.form)} onSubmit={this.handleLoginSubmit}>
          <div>
          ...
          <input type="submit" className={css(style.submit)} value="Login"  disabled={!this.state.enableSubmit}/>
        </form>
      </div>
    );
  }
