...
describe("Notification tests", () => {
  it("Notification rendering", () => {
    const wrapper = shallow(<Notifications />);

    expect(wrapper).toBeDefined();
  });

  it("correct list items rendering", () => {
  ...
  it("correct display when displayDrawer is false", () => {
  ...
  it("undisplay notifications when displayDrawer is false", () => {
    const wrapper = shallow(<Notifications displayDrawer={false} />);

    expect(wrapper.find("div.Notifications").exists()).toBe(false);
  });

  it("undisplay menuItem when displayDrawer is true", () => {
    const wrapper = shallow(<Notifications displayDrawer={true} />);

    expect(wrapper.find("div.menuItem").exists()).toBe(true);
  });

  it("Notifications display when displayDrawer is true", () => {
    const wrapper = shallow(<Notifications displayDrawer={true} />);

    expect(wrapper.find("div.Notifications").exists()).toBe(true);
  });

  it("renders correctly when Courses is not passed", () => {
    const wrapper = shallow(<Notifications displayDrawer={true} />);
  ...
  it('renders the correct string notifications is empty', () => {
    const wrapper = shallow(<Notifications displayDrawer={true} listNotifications={[]} />);
...
describe("ckecking Notification display", () => {
