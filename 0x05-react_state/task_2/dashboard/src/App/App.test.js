...
describe('displayDrawer state', () => {
	it('testing the initial value of displayDrawer to be false', () => {
		const wrapper = mount(<App />);

		expect(wrapper.state().displayDrawer).toBe(false);
	});

	it('testing the value of displayDrawer if it is true after calling handleDisplayDrawer', () => {
	...
	it('testing the value of  displayDrawer if it is false after calling handleHideDrawer', () => {
		const wrapper = shallow(<App />);
